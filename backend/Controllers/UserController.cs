...
public class UserController : Controller
{
    ...
    public async Task<ActionResult<ServiceResponse<bool>>> ResetUserPassword(ResetUserPasswordDto resetUserPassword)
    {
        return Ok(await _userService.ResetUserPassword(resetUserPassword));
    }
}