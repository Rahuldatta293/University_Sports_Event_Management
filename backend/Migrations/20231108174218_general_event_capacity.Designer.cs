...
namespace Backend.Migrations
{
    ...
    [Migration("20231108174218_general_event_capacity")]
    partial class general_event_capacity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.GeneralEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("general_event");
                });

            modelBuilder.Entity("Backend.Models.GeneralReservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Models.GeneralEvent", b =>
                {
                    b.HasOne("Backend.Models.User", "Organizer")
                        .WithMany("OrganizedGeneralEvents")
                        .HasForeignKey("OrganizerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("Backend.Models.GeneralReservation", b =>
                {
                    b.HasOne("Backend.Models.GeneralEvent", "Event")
            ...
            modelBuilder.Entity("Backend.Models.User", b =>
                {
                    b.Navigation("GeneralReservations");

                    b.Navigation("OrganizedEvents");

                    b.Navigation("OrganizedGeneralEvents");
